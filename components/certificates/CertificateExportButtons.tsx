...
export interface CertificateExportButtonsProps {
  /** Ref to the outermost wrapper div that contains the certificate. */
  certRef:   React.RefObject<HTMLDivElement | null>;
  /** Base filename (no extension). Defaults to "certificate". */
  filename?: string;
}
...
export default function CertificateExportButtons({
  ...
  // DOM-clone preview — no canvas, instant, no async.
