...
function Balloons({ side, ivory }: { side: "left" | "right"; ivory: boolean }) {
  ...
  const colors = ivory ? ["#5B1E8C", "#B8860B", "#7B2CBF"] : ["#9D4EDD", GOLD, "#5A189A"];
...
export default function BirthdayCertificate({
  ...
  return (
    ...
    >
      ...
      <ChurchBrand churchName={churchName} churchTagline={churchTagline} logoUrl={logoUrl} ivory={ivory} />
      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "center" }}>
          <MinistrySeal ivory={ivory} sealImageUrl={sealImageUrl} />
        </div>
