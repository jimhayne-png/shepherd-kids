...
export default function MSKioskPage() {
  ...
  useEffect(() => {
    fetch(`/api/middle-school-ministry/checkin-sessions?id=${sessionId}`)
      .then(r => r.json())
      .then(d => {
  ...
  async function handlePhoneLookup() {
    ...
    setLooking(true);
    setLookupError("");
    const res = await fetch("/api/middle-school-ministry/checkin", {
      method: "POST",
  ...
  if (step === "phone") return (
    <div style={containerStyle}>
      <div style={headerStyle}>
        ...
        <h1 style={{ margin: "8px 0 0", fontSize: 28, fontWeight: 900, color: "white" }}>Middle School Check-In</h1>
