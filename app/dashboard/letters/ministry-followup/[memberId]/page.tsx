    ...
    <>
      ...
      <div className="no-print sticky top-0 z-10 bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between shadow-sm">
        <div>
          ...
          <p className="text-xs text-gray-400">{ministryName} — Click anywhere in the letter to edit</p>
        </div>
      ...
      {/* Letter sheet */}
      <div className="min-h-screen bg-gray-100 py-10 no-print-bg">
        <div
