...
export default function MSAttendanceReportPage() {
  ...
  useEffect(() => {
    supabase.auth.getSession().then(({ data: { session } }) => {
      ...
      setToken(t);
      fetch("/api/middle-school-ministry/attendance", {
  ...
  useEffect(() => {
    ...
    fetch(`/api/middle-school-ministry/attendance?sessionId=${selectedSessionId}`, {
